...
class RN24(Net):
    '''
    ResNet24 has a total of 24 layers: 
    ...
    RNB31 - skipMode:identity, output : same as RNB1
    RNB32 - skipMode:identity, output : same as RNB1
    ...
    def __init__(self,para):
        ...
        convPara1 = {'instanceName':'RN24'+'_Conv1',
            'padding':True, 
            'padShape':(1,1),
            'stride':1,
        ...
        self.norm1 = Normalize({'instanceName':'RN24'+'_Norm1'})
        self.scale1 = Scale({'instanceName':'RN24'+'_Scale1'})
        self.activation1 = Activation({'instanceName':'RN24'+'_Activation1',
                                'activationType':'ReLU'})
        ...
        convPara2 = {'instanceName':'RN24'+'_Conv2',
            'padding':True, 
            'padShape':(1,1),
            'stride':2,
        ...
        self.norm2 = Normalize({'instanceName':'RN24'+'_Norm2'})
        self.scale2 = Scale({'instanceName':'RN24'+'_Scale2'})
        self.activation2 = Activation({'instanceName':'RN24'+'_Activation2',
                                'activationType':'ReLU'})
        ...
        self.rnb1 = ResNetBlock({'instanceName':'RN24'+'_RNB1', 
            'skipMode': 'identity', 
            'skipStride': 0,
            'stride1': 1,
        ...
        self.rnb2 = ResNetBlock({'instanceName':'RN24'+'_RNB2', 
            'skipMode': 'identity', 
            'skipStride': 0,
            'stride1': 1,
            'outChannel1': int(para['rnb1OutChannel']/4),
        ...
        self.rnb3 = ResNetBlock({'instanceName':'RN24'+'_RNB3', 
            'skipMode': 'identity', 
            'skipStride': 0,
            'stride1': 1,
            'outChannel1': int(para['rnb1OutChannel']/4),
        ...
        self.rnb31 = ResNetBlock({'instanceName':'RN24'+'_RNB31', 
            'skipMode': 'identity', 
            'skipStride': 0,
            'stride1': 1,
            'outChannel1': int(para['rnb1OutChannel']/4),
        ...
        self.layerList.append(self.rnb31)
        self.rnb32 = ResNetBlock({'instanceName':'RN24'+'_RNB32', 
            'skipMode': 'identity', 
            'skipStride': 0,
            'stride1': 1,
            'outChannel1': int(para['rnb1OutChannel']/4),
        ...
        self.layerList.append(self.rnb32)
        self.rnb4 = ResNetBlock({'instanceName':'RN24'+'_RNB4', 
            'skipMode': 'conv', 
            'skipStride': 2,
            'stride1': 2,
        ...
        self.rnb5 = ResNetBlock({'instanceName':'RN24'+'_RNB5', 
            'skipMode': 'identity', 
            'skipStride': 1,
            'stride1': 1,
            'outChannel1': int(para['rnb4OutChannel']/4),
        ...
        self.pool1 = Pool({'instanceName':'RN24'+'_pool1', 'poolType':'ave', 
            'stride':para['pSize'], 'kernelShape':(para['pSize'],para['pSize'])})
        self.layerList.append(self.pool1)
        self.fc1 = FullyConnected({'instanceName':'RN24'+'_fc1','outChannel':para['classNum'],
            'bias':True})
        self.layerList.append(self.fc1)
        self.softmax = Softmax({'instanceName':'RN24'+'_softmax'})
    ...
    def stack(self,top,bottom):
        ...
        self.rnb3.stack(self.rnb31,self.rnb2)
        self.rnb31.stack(self.rnb32,self.rnb3)
        self.rnb32.stack(self.rnb4,self.rnb31)
        self.rnb4.stack(self.rnb5,self.rnb32)
